...
Este repositório deve conter a raiz `PortalEducacional/`, com `apps/portal`, `supabase`, `modules` e `docs`.
...
- novo GitHub: sim;
- novo Vercel: sim;
- novo Supabase: somente se quisermos zerar schema/dados com segurança.
