...
- Implementar `docs/prd-sinais-da-missao.md`: autoavaliacao leve ao final das missoes, tempo invisivel, leitura combinada pela IA e orientacao esperancosa para o adulto, sem diagnostico ou ranking.
- Consolidar Redacao, Interpretacao e Tabuada no mesmo GitHub do Portal Educacional, preferencialmente como um monorepo organizado por modulos. A Tabuada ja esta dentro do Portal; Redacao e Interpretacao ainda devem ser trazidas para o mesmo projeto/repo, preservando os deploys atuais ate a migracao ser testada. Objetivo: um unico projeto versionado, contrato comum de modulos, identidade visual integrada, historico centralizado e menor risco de divergencia entre produtos.
...
- Redacao: permitir e orientar o uso do microfone nativo do celular/teclado para a crianca ditar as partes da redacao dentro do fluxo de comeco, meio e fim. Nao precisa de IA para transcrever; o proprio dispositivo transforma fala em texto. Hipotese pedagogica: reduzir atrito de digitacao e focar no processo de organizar ideias, que pode ser mais importante neste momento do que praticar escrita no celular/computador. Ressalva: validar com especialista da area antes de transformar essa estrategia em recomendacao central do produto.
...
- Redacao com revisao final curta e editavel: a crianca pode melhorar uma coisa antes da analise, e o Portal recebe apenas a versao final revisada para nao poluir o acompanhamento adulto.
